...
import { AIMessage, CaseSummary, Specialty, UserContactData } from '../../constants/Types';
...
export default function AIChat({ userId, onNavigateToExperts }: AIChatProps) {
  ...
  // NEW: Handle escalation to experts
  ...
  // NEW: Handle user data submission
  ...
  return (
    ...
    >
      <View style={[styles.header, { backgroundColor: colors.cardBackground, borderBottomColor: colors.border }]}>
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerText}>
            <Text style={[styles.headerTitle, { color: colors.text }]}>Asistente Fiscal IA</Text>
            <Text style={[styles.headerSubtitle, { color: colors.textSecondary }]}>
              {questionsRemaining} {questionsRemaining === 1 ? 'pregunta restante' : 'preguntas restantes'}
            </Text>
          </View>
        </View>
      ...
      <View style={[styles.inputContainer, { backgroundColor: colors.cardBackground, borderTopColor: colors.border }]}>
        ...
        <View style={styles.inputRow}>
          <TextInput
            ...
            placeholder={canAskMore ? 'Escribe tu pregunta fiscal...' : 'Límite de preguntas alcanzado'}
      ...
      {/* NEW: Escalation buttons for yellow/red cases */}
      {(caseLevel === 'yellow' || caseLevel === 'red') && onNavigateToExperts && (
        <View style={[styles.escalationContainer, { backgroundColor: colors.cardBackground, borderTopColor: colors.border }]}>
          <TouchableOpacity
            style={[
              styles.escalationButton,
              {
                backgroundColor: caseLevel === 'red' ? colors.error : colors.warning,
              },
            ]}
